...
export const GENESIS_PERSONAS: PersonaProfile[] = [
  ...
  },
  {
    ...
    name: 'ERNA BOYKELA R',
    role: 'TEACHER',
    roleTitle: 'Guru Kelas TK A',
    schoolId: 'sch_tk_maranatha',
    schoolName: 'TK YAPENDIK GPIB Cabang Maranatha',
    personId: 'per_teacher_erna',
    assignedClasses: ['cls_maranatha_tka'],
    guardianChildrenPersonIds: [],
    description: 'Guru Inti Sentra Kurikulum Merdeka PAUD Kelas TK A.',
    isSimulation: true,
  ...
  },
  {
    ...
    roleTitle: 'Guru Pendamping Kelas TK A',
    schoolId: 'sch_tk_maranatha',
    schoolName: 'TK YAPENDIK GPIB Cabang Maranatha',
    personId: 'per_teacher_charlotha',
    assignedClasses: ['cls_maranatha_tka'],
    guardianChildrenPersonIds: [],
    description: 'Guru Pendamping & Literasi Anak Usia Dini Kelas TK A.',
    isSimulation: true,
  ...
  },
  {
    ...
    name: 'EVI TANIA',
    role: 'TEACHER',
    roleTitle: 'Guru Kelas TK B',
    schoolId: 'sch_tk_maranatha',
    schoolName: 'TK YAPENDIK GPIB Cabang Maranatha',
    personId: 'per_teacher_evi',
    assignedClasses: ['cls_maranatha_tkb'],
    guardianChildrenPersonIds: [],
    description: 'Guru Inti Perkembangan Motorik & Sentra Kelas TK B.',
    isSimulation: true,
  ...
  },
  {
    ...
    name: 'JULEN PATRICIA',
    role: 'GUARDIAN',
    roleTitle: 'Orang Tua / Wali Murid (Wali Millen - Kelas TK A)',
    schoolId: 'sch_tk_maranatha',
    schoolName: 'TK YAPENDIK GPIB Cabang Maranatha',
    personId: 'per_guard_julen_patricia',
    assignedClasses: [],
    guardianChildrenPersonIds: ['per_child_millen'],
    description: 'Wali sah Ananda Jequaline Arabella (Millen) di Kelas TK A.',
    isSimulation: true,
  ...
  },
  {
    ...
    name: 'MUTIARA ZEGA',
    role: 'GUARDIAN',
    roleTitle: 'Orang Tua / Wali Murid (Wali Kayla - Kelas TK B)',
    schoolId: 'sch_tk_maranatha',
    schoolName: 'TK YAPENDIK GPIB Cabang Maranatha',
    personId: 'per_guard_mutiara_zega',
    assignedClasses: [],
    guardianChildrenPersonIds: ['per_child_kayla'],
    description: 'Wali sah Ananda Kayla Gabriella di Kelas TK B.',
    isSimulation: true,
