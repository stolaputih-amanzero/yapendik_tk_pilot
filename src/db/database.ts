...
export class DatabaseEngine {
  ...
  private initialize() {
    try {
      ...
      this.attendance = this.loadOrSeed('attendance', SEED_ATTENDANCE);
      this.notices = this.loadOrSeed('notices', SEED_GUARDIAN_NOTICES);
      this.auditLogs = this.loadOrSeed('audit_logs', SEED_AUDIT_LOGS);
