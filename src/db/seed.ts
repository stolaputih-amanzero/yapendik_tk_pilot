...
export const SEED_LEARNING_ACTIVITIES: LearningActivity[] = [
  {
    id: 'act_maranatha_001',
    schoolId: 'sch_tk_maranatha',
    classId: 'cls_maranatha_tka',
    date: '2026-08-26',
    theme: 'Diriku & Panca Indra Ciptaan Tuhan',
    subTheme: 'Mengenal Rasa Manis, Asin, Asam, dan Gurih',
    ...
    materialsNeeded: [
      ...
      'Irisan jeruk nipis',
      'Larutan gula & madu dalam sendok kecil',
      'Kartu ekspresi rasa (tersenyum, tertawa, kaget)',
      'Lembar dokumentasi anak'
    ],
    plannedSteps: [
      'Lingkaran pagi: Doa bersama dan apersepsi tentang indra pengecap lidah sebagai anugerah Tuhan.',
      'Anak mencicipi sampel buah secara bergantian dalam kelompok kecil.',
    ...
    teacherReflection: 'Ananda Millen dan Carissa sangat antusias mencoba jeruk nipis dan tertawa bersama saat mendeskripsikan rasanya.',
    completed: true
  },
  {
    id: 'act_maranatha_002',
    schoolId: 'sch_tk_maranatha',
    classId: 'cls_maranatha_tka',
    date: '2026-08-26',
    theme: 'Diriku & Panca Indra Ciptaan Tuhan',
    subTheme: 'Indra Penglihatan & Seni Warna',
    ...
    teacherReflection: 'Rainer dan Falen menunjukkan koordinasi motorik halus yang sangat baik saat membuat gradasi warna.',
    completed: true
  },
  {
    id: 'act_maranatha_003',
    schoolId: 'sch_tk_maranatha',
    classId: 'cls_maranatha_tkb',
    date: '2026-08-26',
    theme: 'Lingkunganku & Ciptaan Tuhan',
    subTheme: 'Sentra Balok & Konstruksi Bangunan',
    timeSlot: '08:30 - 10:00',
    activityName: 'Membangun Menara dan Jembatan Sahabat',
    developmentalFocus: ['KOGNITIF', 'FISIK_MOTORIK', 'SOSIAL_EMOSIONAL'],
    materialsNeeded: [
      'Balok kayu aneka bentuk (silinder, prisma, kubus)',
      'Miniatur pohon dan jembatan',
      'Alas bermain busa'
    ],
    plannedSteps: [
      'Diskusi perencanaan bentuk jembatan dan menara bersama teman.',
      'Bermain peran membangun jembatan persahabatan secara kooperatif.',
      'Mengukur kestabilan susunan balok.',
      'Evaluasi dan merapikan balok ke rak sentra.'
    ],
    teacherReflection: 'Kayla dan Dominic bekerja sama dengan sangat kompak menyeimbangkan balok jembatan.',
    completed: true
  }
];
...
export const SEED_OBSERVATIONS: ObservationRecord[] = [
  {
    id: 'obs_maranatha_001',
    schoolId: 'sch_tk_maranatha',
    classId: 'cls_maranatha_tka',
    studentId: 'stu_maranatha_01',
    observerPersonId: 'per_teacher_erna',
    observedAt: '2026-08-26T09:15:00Z',
    domain: 'KOGNITIF',
    anecdoteDescription: 'Saat kegiatan sentra rasa, Millen mampu membedakan rasa manis madu dan asam jeruk nipis. Ketika ditanya oleh Bu Erna, Millen menjawab dengan gembira: "Jeruk nipisnya asam segar bu, kalau madunya manis seperti kue ulang tahun!"',
    behaviorTrigger: 'Mencicipi madu dan perasan jeruk nipis menggunakan sendok kayu kecil',
    childReaction: 'Mengekspresikan senyum ceria dan menjelaskan pengalaman rasa dengan artikulasi yang sangat jelas',
    teacherIntervention: 'Memberikan penguatan positif dan mengajak Millen menceritakan buah favorit keluarga di rumah',
    milestoneRating: 'BSB',
    indicatorsObserved: ['Membedakan rasa manis dan asam', 'Mengekspresikan gagasan dengan kalimat runtut'],
    isConfidentialToStaff: false,
    sharedWithGuardian: true,
    createdAt: '2026-08-26T09:30:00Z'
  },
  {
    id: 'obs_maranatha_002',
    schoolId: 'sch_tk_maranatha',
    classId: 'cls_maranatha_tka',
    studentId: 'stu_maranatha_02',
    observerPersonId: 'per_teacher_erna',
    observedAt: '2026-08-26T10:45:00Z',
    domain: 'SOSIAL_EMOSIONAL',
    anecdoteDescription: 'Ketika wadah kuas cat Falen berguling di meja, Carissa dengan sigap mengambilkan kuas tersebut dan merapikannya sambil tersenyum: "Ini Falen kuasnya, kita cat bareng yuk." Carissa menunjukkan empati dan kemauan berbagi.',
    behaviorTrigger: 'Kuas gambar teman terjatuh',
    childReaction: 'Menunjukkan inisiatif tolong-menolong secara spontan tanpa diminta pendidik',
    teacherIntervention: 'Memuji empati dan keramahan Carissa di depan teman-teman kelas',
    milestoneRating: 'BSB',
    indicatorsObserved: ['Menunjukkan kepedulian terhadap teman', 'Berbagi dan bergotong royong'],
    isConfidentialToStaff: false,
    sharedWithGuardian: true,
    createdAt: '2026-08-26T11:00:00Z'
  },
  {
    id: 'obs_maranatha_003',
    schoolId: 'sch_tk_maranatha',
    classId: 'cls_maranatha_tkb',
    studentId: 'stu_maranatha_10',
    observerPersonId: 'per_teacher_evi',
    observedAt: '2026-08-26T09:30:00Z',
    domain: 'KOGNITIF',
    anecdoteDescription: 'Kayla berhasil menyusun 8 balok kayu secara bertingkat membentuk menara yang stabil. Kayla menghitung balok satu per satu: "Satu, dua, tiga... ada delapan balok Bu Evi, menaraku tinggi sekali!"',
    behaviorTrigger: 'Membangun konstruksi balok di sentra main',
    childReaction: 'Percaya diri dan tersenyum bangga atas karya bangunannya',
    teacherIntervention: 'Mengajak Kayla membandingkan ukuran balok yang berada di dasar dan puncak menara',
    milestoneRating: 'BSB',
    indicatorsObserved: ['Mengenal konsep bilangan dan membilang benda', 'Keseimbangan konstruksi spasial'],
    isConfidentialToStaff: false,
    sharedWithGuardian: true,
    createdAt: '2026-08-26T09:45:00Z'
  },
  {
    id: 'obs_maranatha_004',
    schoolId: 'sch_tk_maranatha',
    classId: 'cls_maranatha_tkb',
    studentId: 'stu_maranatha_11',
    observerPersonId: 'per_teacher_evi',
    observedAt: '2026-08-26T10:15:00Z',
    domain: 'FISIK_MOTORIK',
    anecdoteDescription: 'Dominic mampu melompat dengan dua kaki seimbang melewati rintangan lingkaran hula hoop secara lincah tanpa kehilangan keseimbangan.',
    milestoneRating: 'BSH',
    indicatorsObserved: ['Koordinasi motorik kasar', 'Keseimbangan gerak melompat'],
    isConfidentialToStaff: false,
    sharedWithGuardian: true,
...
export const SEED_ATTENDANCE: DailyAttendanceEntry[] = [
  // Class A Attendance (2026-08-26)
  {
    ...
    date: '2026-08-26',
    status: 'HADIR',
    recordedByPersonId: 'per_teacher_erna',
    recordedAt: '2026-08-26T07:45:00Z',
    temperatureCelsius: 36.4,
    arrivalMood: 'CERIA',
    notes: 'Datang diantar mama, menyapa guru dengan senyum ramah.'
  },
  {
    id: 'att_maranatha_02',
    schoolId: 'sch_tk_maranatha',
    ...
    status: 'HADIR',
    recordedByPersonId: 'per_teacher_erna',
    recordedAt: '2026-08-26T07:48:00Z',
  ...
  },
  {
    ...
    schoolId: 'sch_tk_maranatha',
    classId: 'cls_maranatha_tka',
    studentId: 'stu_maranatha_03',
    date: '2026-08-26',
    status: 'HADIR',
    recordedByPersonId: 'per_teacher_erna',
    recordedAt: '2026-08-26T07:50:00Z',
    temperatureCelsius: 36.6,
    arrivalMood: 'TENANG',
    notes: 'Aktif menyapa teman di lingkaran pagi.'
  },
  {
    id: 'att_maranatha_04',
    schoolId: 'sch_tk_maranatha',
    classId: 'cls_maranatha_tka',
    studentId: 'stu_maranatha_04',
    date: '2026-08-26',
    status: 'HADIR',
    recordedByPersonId: 'per_teacher_erna',
    recordedAt: '2026-08-26T07:52:00Z',
    temperatureCelsius: 36.4,
    arrivalMood: 'CERIA'
  },
  {
    ...
    schoolId: 'sch_tk_maranatha',
    classId: 'cls_maranatha_tka',
    studentId: 'stu_maranatha_05',
    date: '2026-08-26',
    status: 'HADIR',
    recordedByPersonId: 'per_teacher_erna',
    recordedAt: '2026-08-26T07:55:00Z',
    temperatureCelsius: 36.5,
    arrivalMood: 'CERIA'
  },
  {
    ...
    schoolId: 'sch_tk_maranatha',
    classId: 'cls_maranatha_tka',
    studentId: 'stu_maranatha_06',
    date: '2026-08-26',
    status: 'HADIR',
    recordedByPersonId: 'per_teacher_erna',
    recordedAt: '2026-08-26T07:56:00Z',
    temperatureCelsius: 36.5,
    arrivalMood: 'TENANG'
  },
  {
    ...
    schoolId: 'sch_tk_maranatha',
    classId: 'cls_maranatha_tka',
    studentId: 'stu_maranatha_07',
    date: '2026-08-26',
    status: 'HADIR',
    recordedByPersonId: 'per_teacher_erna',
    recordedAt: '2026-08-26T07:58:00Z',
    temperatureCelsius: 36.6,
    arrivalMood: 'CERIA'
  },
  {
    ...
    schoolId: 'sch_tk_maranatha',
    classId: 'cls_maranatha_tka',
    studentId: 'stu_maranatha_08',
    date: '2026-08-26',
    status: 'HADIR',
    recordedByPersonId: 'per_teacher_erna',
    recordedAt: '2026-08-26T07:59:00Z',
    temperatureCelsius: 36.5,
    arrivalMood: 'CERIA'
  },
  {
  ...
  // Class B Attendance (2026-08-26)
  {
    ...
    date: '2026-08-26',
    status: 'HADIR',
    recordedByPersonId: 'per_teacher_evi',
    recordedAt: '2026-08-26T07:45:00Z',
    temperatureCelsius: 36.5,
    arrivalMood: 'CERIA',
    notes: 'Bersemangat masuk ke sentra balok TK B.'
  },
  {
    id: 'att_maranatha_11',
    schoolId: 'sch_tk_maranatha',
  ...
  },
  {
    ...
    schoolId: 'sch_tk_maranatha',
    classId: 'cls_maranatha_tkb',
    studentId: 'stu_maranatha_14',
    date: '2026-08-26',
    status: 'HADIR',
    recordedByPersonId: 'per_teacher_evi',
    recordedAt: '2026-08-26T07:54:00Z',
    temperatureCelsius: 36.6,
    arrivalMood: 'CERIA'
  },
  {
...
export const SEED_GUARDIAN_NOTICES: GuardianNotice[] = [
  {
    id: 'notif_maranatha_001',
    schoolId: 'sch_tk_maranatha',
    classId: 'cls_maranatha_tka',
    studentId: 'stu_maranatha_01',
    authorPersonId: 'per_teacher_erna',
    recipientPersonId: 'per_guard_julen_patricia',
    type: 'DAILY_SUMMARY',
    title: 'Catatan Harian Ananda Millen (26 Agustus 2026)',
    content: 'Selamat siang Mama Millen. Hari ini Ananda Millen sangat ceria dan antusias di sentra bermain. Millen aktif bereksplorasi rasa dan menyampaikan pendapatnya dengan sangat baik. Nafsu makan siang lahap. Terima kasih atas kerja sama keluarga yang luar biasa.',
    requiresAcknowledgment: true,
    acknowledgedAt: '2026-08-26T12:30:00Z',
    acknowledgedByPersonId: 'per_guard_julen_patricia',
    guardianReply: 'Terima kasih banyak Bu Erna atas pendampingan penuh kasih hari ini. Millen sangat senang bercerita tentang aktivitas di sekolah.',
    createdAt: '2026-08-26T11:45:00Z'
  },
  {
    id: 'notif_maranatha_002',
    schoolId: 'sch_tk_maranatha',
    classId: 'cls_maranatha_tkb',
    studentId: 'stu_maranatha_10',
    authorPersonId: 'per_teacher_evi',
    recipientPersonId: 'per_guard_mutiara_zega',
    type: 'DAILY_SUMMARY',
    title: 'Catatan Harian Ananda Kayla (26 Agustus 2026)',
    content: 'Selamat siang Mama Kayla. Hari ini Kayla menunjukkan perkembangan kognitif dan sosial yang mengagumkan saat bekerja sama menyusun balok bersama teman-teman Kelompok B.',
    requiresAcknowledgment: true,
    acknowledgedAt: '2026-08-26T12:35:00Z',
    acknowledgedByPersonId: 'per_guard_mutiara_zega',
    guardianReply: 'Terima kasih Bu Evi, Kayla sangat senang dan antusias belajar di Kelompok B hari ini.',
    createdAt: '2026-08-26T11:45:00Z'
  },
  {
    id: 'notif_maranatha_003',
    schoolId: 'sch_tk_maranatha',
    classId: 'cls_maranatha_tka',
    authorPersonId: 'per_teacher_erna',
    type: 'CLASS_ANNOUNCEMENT',
    title: 'Pengumuman Kegiatan Sentra Eksplorasi Bersama Orang Tua',
    content: 'Bapak/Ibu Orang Tua Siswa TK Maranatha yang terkasih, terima kasih atas pendampingan penuh kasih kepada ananda. Kegiatan belajar minggu ini berfokus pada penguatan karakter, kemandirian, dan eksplorasi sensori anak usia dini.',
...
export const SEED_AUDIT_LOGS: AuditLogEntry[] = [
  {
    id: 'aud_maranatha_001',
    schoolId: 'sch_tk_maranatha',
    userId: 'user_teacher_erna',
    personName: 'ERNA BOYKELA R',
    role: 'TEACHER',
    action: 'CREATE_OBSERVATION',
    resource: 'STUDENT_OBSERVATION',
    resourceId: 'obs_maranatha_001',
    details: 'Merekam catatan anekdot perkembangan kognitif untuk ananda Millen (Rating: BSB)',
    timestamp: '2026-08-26T09:30:00Z'
  },
  {
    id: 'aud_maranatha_002',
    schoolId: 'sch_tk_maranatha',
    userId: 'user_guard_julen',
    personName: 'JULEN PATRICIA',
    role: 'GUARDIAN',
    action: 'ACKNOWLEDGE_NOTICE',
    resource: 'GUARDIAN_COMMUNICATION',
    resourceId: 'notif_maranatha_001',
    details: 'Orang tua ananda Millen menandatangani tanda terima catatan harian dan mengirimkan respon apresiasi',
    timestamp: '2026-08-26T12:30:00Z'
  },
  {
    id: 'aud_maranatha_003',
    schoolId: 'sch_tk_maranatha',
    userId: 'user_teacher_evi',
    personName: 'EVI TANIA',
    role: 'TEACHER',
    action: 'CREATE_OBSERVATION',
    resource: 'STUDENT_OBSERVATION',
    resourceId: 'obs_maranatha_003',
    details: 'Merekam catatan perkembangan kognitif Kayla di sentra balok (Rating: BSB)',
