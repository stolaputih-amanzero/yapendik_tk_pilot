      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-3.5 py-1.5 rounded-xl text-xs font-bold bg-indigo-600 text-white hover:bg-indigo-500 transition shadow-sm flex items-center gap-1.5 cursor-pointer"
          >
        ...
        {filtered.length > 0 ? (
          filtered.map(n => {
            ...
            return (
              <div
                key={n.id}
                className={`p-4 rounded-2xl border transition bg-white shadow-sm ${
                  !isAck
                  ...
                  <div className="mt-3 pt-3 border-t border-slate-200 dark:border-slate-800 space-y-2">
                    ...
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <button
                        ...
                        className="px-4 py-1.5 rounded-xl text-xs font-bold bg-indigo-600 text-white hover:bg-indigo-500 flex items-center gap-1.5"
                      >
          ...
          <div className="bg-white dark:bg-slate-900 border border-dashed border-slate-300 dark:border-slate-800 rounded-2xl p-8 text-center text-slate-500 text-xs">
