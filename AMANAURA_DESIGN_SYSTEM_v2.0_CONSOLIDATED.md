# AMANAURA DESIGN SYSTEM v2.0 (CONSOLIDATED)
## The Warm, Tactile, and Dignified Operating Experience

### META
* **Document ID:** `DOC-AMANAURA-DS-v2.0-CONSOLIDATED`
* **Version:** `2.0-RELEASE`
...
### 2.1 Hukum Palet Warna 60 - 30 - 10 (Tailwind v4 `@theme`)
...
├── SplitPaneWorkspace.tsx     # Master-Detail layout engine dengan fallback responsif
├── useInstallPrompt.ts        # Hook untuk menangkap beforeinstallprompt & memicu Soft Install UI
├── useOfflineStatus.ts        # Hook untuk mendeteksi navigator.onLine & menampilkan Status Dot Capsule
└── offlineQueue.ts            # Service untuk membaca/menulis IndexedDB Mutation Queue
```
...
> **📜 PROKLAMASI RILIS KANONIKAL: AMANAURA v2.0-RELEASE**  
> 
> Dengan selesainya *12-Step Implementation Roadmap*, dokumen **AMANAURA DESIGN SYSTEM v2.0 (Consolidated)** secara resmi dinaikkan statusnya dari *Draft* menjadi **STANDAR DESAIN GLOBAL PERMANEN & KANONIKAL** untuk *Yapendik School OS*.
>
> Dokumen ini secara mutlak menggantikan *Specification v1.0* dan *Refactoring Playbook v1.1*. Seluruh rekayasa antarmuka pengguna, arsitektur PWA, dan adaptasi Tablet Android/DeX di masa kini dan masa depan **WAJIB** tunduk pada hukum visual, token sistem, dan protokol audit yang termaktub di dalam v2.0-RELEASE.
>  
> * **Status Resmi:** `v2.0-RELEASE` (CANONICAL LIVING MASTER SPECIFICATION)
> * **Roadmap 12-Step:** 🟢 **100% COMPLETE & RATIFIED**
> * **Kepatuhan Stage 4.5:** 348/348 Checks PASS, FB-01 s.d. FB-07 ENFORCED, H-01 s.d. H-06 GUARANTEED.
>
> **Disahkan oleh:** Senior Architecture Reviewer (ARB) & Project Owner  
> **Tanggal Pensegelan:** `2026-08-28`  
> **Baseline Hash:** `CANONICAL-AMANAURA-V2.0-RELEASE-HASH-20260828`
>
> **Referensi Stage 4.5 Architecture Certification:**
> * `STAGE_4_5_FINAL_CLOSURE_AND_ARCHITECTURE_CERTIFICATION_v1.0.md`
> * **348/348 automated checks PASS** (100% Zero Regression)
> * **FB-01 s.d. FB-07 invariants ENFORCED**
> * **H-01 s.d. H-06 hardenings GUARANTEED**
> * **ADR-01 s.d. ADR-04 infrastructure SEALED**
